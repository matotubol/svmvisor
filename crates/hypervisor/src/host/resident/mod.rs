...
pub use crate::{
    ...
    host::resident::abi::{
        ...
        X2AVIC_TABLE_OFFSET, captured_register_refusal, is_valid_pool_slot,
        svmvisor_resident_callback, svmvisor_resident_guest_ack, svmvisor_resident_guest_after_ack,
