...
$candidate='target/firmware/squirrel/native-returning/80d4c81a79484ba1a04fc1a79af89342'
...
$sessionsRoot=Join-Path $root 'target/firmware/squirrel/card-diagnostics-sessions'
