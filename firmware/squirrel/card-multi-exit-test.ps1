...
$candidate='target/firmware/squirrel/native-returning/c8773e334da54b40aa2acab15beee1e5'
...
$sessionsRoot=Join-Path $root 'target/firmware/squirrel/card-multi-exit-sessions'
